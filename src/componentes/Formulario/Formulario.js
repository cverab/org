...
const Formulario = (props) => {
    ...
    const manejarEnvio = (e) => {
        ...
        //TAMBIEN ES VALIDO
        //let datosAEnviar = {nombre: nombre, puesto: puesto, foto: foto, equipo: equipo}
    ...
    return <section className="formulario">
        ...
        <form onSubmit={manejarNuevoEquipo}>
            ...
            <Campo titulo="Color" placeholder="Ingresar en hexadecimal" required valor={color} actualizarValor={actualizarColor} type="color" />
